    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("SmallChange version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  caticoin [options]                     " + "\n" +
                  "  caticoin [options] <command> [params]  " + _("Send command to -server or caticoin") + "\n" +
                  "  caticoin [options] help                " + _("List commands") + "\n" +
                  "  caticoin [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "caticoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: caticoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: caticoin.pid)") + "\n" +
...
//    }
    ...
    // Make sure only a single caticoin process is using the data directory.
    ...
    // requested to kill caticoin-qt during the last operation. If so, exit.
