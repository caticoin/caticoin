...
static const int64 MAX_MONEY = GLOBAL_MAX_MONEY * COIN; // maximum of 42 007 680 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * BLOCKXDAY / 250; // 5760 blocks found a day. Priority cutoff is 1 SMC day / 250 bytes.
    }
