...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "caticoin.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No caticoin.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override caticoin.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "caticoin.pid"));
